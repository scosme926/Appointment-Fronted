    ...
    return(
      <>
        ...
        <div className="w3-hide-large">
          ...
          <div className="w3-col s6  w3-panel w3-rightbar w3-border-black">
          ...
          <div className="w3-col s6 w3-center w3-panel w3-leftbar w3-border-black">
          ...
          <div className="w3-row">
            ...
            <div className="w3-col s2 w3-center"><p></p></div>
